...
from animal_spot.utils.summary import plot_spectrogram

from animal_spot.utils.logging import PredictionLogger

from animal_spot.models.classifier import Classifier
from animal_spot.models.residual_encoder import ResidualEncoder as Encoder
from animal_spot.data.audiodataset import StridedAudioDataset, DefaultSpecDatasetOps
...
def start_predict(ARGS):
    ...
    if ARGS.jit_load:
        ...
        model_dict = torch.load(ARGS.model_path, map_location=ARGS.device)
        ...
        class_dist_dict = model_dict.get("classes", {"noise": 0, "target": 1})
