...
import argparse
import platform
from animal_spot.utils import metrics as m
...
from animal_spot.data.audiodataset import (
...
from animal_spot.trainer import Trainer
from animal_spot.utils.logging import Logger
from collections import OrderedDict
from animal_spot.models.residual_encoder import DefaultEncoderOpts
from animal_spot.models.residual_encoder import ResidualEncoder as Encoder
from animal_spot.models.classifier import Classifier, DefaultClassifierOpts
...
"""
def get_audio_files(ARGS, input_data, log):
...
def start_train(ARGS):
    ...
    audio_files = get_audio_files(ARGS, input_data, log)
